...
const customerLinks = [["Overview","/account/dashboard"],["Marketplace","/search"],["Profile","/account/profile"],["Orders","/account/orders"],["Payment status","/account/payments"],["Custom orders","/account/custom-orders"],["Wishlist","/account/wishlist"],["Notifications","/account/notifications"],["Support","/account/support"],["Studio application","/sell-on-sidra/status"]] as const;
