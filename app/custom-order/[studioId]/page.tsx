...
export default async function CustomOrderRequestPage({
  ...
  return <main className="mx-auto w-full max-w-5xl px-5 py-12 sm:px-8">
    <header className="mb-10">
      ...
      <p className="mt-4 max-w-3xl leading-7 text-muted">Share a complete brief. The Studio will review it, ask clarifying questions when needed, and send a formal quote before any payment.</p>
    </header>
